  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#030712] relative overflow-hidden font-sans">
      ...
      <div className="fixed inset-0 z-0">
        <div className="absolute top-[10%] right-[-10%] w-[50%] h-[50%] bg-indigo-600/30 rounded-full blur-[150px] mix-blend-screen animate-blob" />
        <div className="absolute bottom-[-10%] left-[-10%] w-[50%] h-[50%] bg-cyan-600/30 rounded-full blur-[150px] mix-blend-screen animate-blob animation-delay-2000" />
      ...
      >
        ...
        <div className="relative z-10">
          <div className="text-center mb-8 flex flex-col items-center">
            ...
            <p className="text-slate-400 font-medium">Sign in to manage your certificates.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            >
              {loading ? <Loader2 className="animate-spin" size={20} /> : (
                <>Secure Sign In <Sparkles size={18} className="group-hover:rotate-12 transition-transform"/></>
              )}
            </button>
          </form>
          ...
          <p className="mt-8 text-center text-slate-400 font-medium text-sm">
            ...
            <Link href="/register" className="text-cyan-400 font-bold hover:text-cyan-300 hover:underline transition-colors">
              Create Account
            </Link>
          </p>
        </div>
